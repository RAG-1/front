...
function createMessageBubble(content, sender = "user") {
    ...
    if (sender === "user") wrapper.className = "mb-6 flex flex-row-reverse items-start justify-end space-x-3 space-x-reverse";
    ...
    if (sender === "user") bubble.classList.add("bg-gray-200", "text-gray-900", "ml-auto");
    else bubble.classList.add("bg-pink-600", "text-white");
    bubble.textContent = content;
    if (sender === "assistant") {
        const avatar = document.createElement("div");
        avatar.className = "w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center font-bold bg-gradient-to-br from-green-400 to-green-600 overflow-hidden";
...
window.addEventListener("DOMContentLoaded", ()=>{
    chatContainer.appendChild(createMessageBubble('\uC548\uB155\uD558\uC138\uC694. \uB2F9\uC2E0\uC758 \uCF54\uB4DC\uB97C \uD2B8\uB80C\uB4DC\uD558\uAC8C \uBC14\uAFD4\uC904 "\uB378\uD0C0\uCE90\uCC98"\uC785\uB2C8\uB2E4!', "assistant"));
    scrollToBottom();
});

},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire0b10", {})

//# sourceMappingURL=front.0f77c784.js.map
